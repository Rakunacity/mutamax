...
Without <b>mutamax</b> library the example below would contain 2 nested loops with different manual transformations, in
case response/request is a collection.
